  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        primary:
          "bg-violet-400 text-primary-foreground hover:bg-violet-400/90 border-violet-500 border-b-4 active:border-b-0",
        primaryOutline: "bg-white text-violet-500 hover:bg-slate-00",
        secondary:
          "bg-zinc-500 text-primary-foreground hover:bg-zinc-400 border-zinc-600 border-b-4 active:border-b-0",
        secondaryOutline: "bg-white text-zinc-500 hover:bg-slate-300",
        danger:"bg-rose-600 text-primary-foreground hover:bg-rose-500 border-rose-700 border-b-4 active:border-b-0",
        dangerOutline:"bg-white text-red-500 hover:bg-red-200",
        super:"bg-amber-400 text-primary-foreground hover:bg-amber-300 border-amber-500 border-b-4 active:border-b-0",
        superOutline:"bg-white text-amber-500 hover:bg-amber-100",
